...
with tab_home:
    ...
    # KPI KARTLARI (HTML Güvenli Hale Getirildi)
    ...
    with c3:
        ...
        <div class="kpi-card" style="border-top-color: #10b981;">
            <div class="kpi-number">{basari}</div>
            <div class="kpi-label">Anlaşıldı</div>
        </div>
        """, unsafe_allow_html=True)
        ...
        with g2:
            ...
            if "Hatirlatici_Tarih" in df.columns:
                ...
                if not isler.empty:
                    ...
                    st.success("Bugün için acil iş yok.")
